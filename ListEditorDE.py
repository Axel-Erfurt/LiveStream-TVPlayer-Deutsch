...
class Viewer(QMainWindow):
    def __init__(self, parent=None):
      ...
      self.setWindowTitle("TVPlayer2 Listeneditor")
    ...
    def createMenuBar(self):
        ...
        self.filemenu.addAction(QIcon.fromTheme("document-open"), "Datei öffnen",  self.load_channels_file, QKeySequence.Open) 
    ...
    def openFile(self, path=None):
        ...
        path, _ = QFileDialog.getOpenFileName(self, "Datei öffnen", tvplayer_folder,"TVPlayer2 List (*.txt)")
        if path:
            return path
